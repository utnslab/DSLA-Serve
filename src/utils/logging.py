    ...
    def on_log(
        ...
        **kwargs
        ...
        logs = dict(
            ...
            hard_loss=state.log_history[-1].get("hard_loss", None),
            soft_loss=state.log_history[-1].get("soft_loss", None),
            layer_kl_loss=state.log_history[-1].get("layer_kl_loss", None),
